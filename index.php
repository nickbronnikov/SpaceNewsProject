...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Merriweather:300i,400,400i,700,900&amp;subset=cyrillic,cyrillic-ext,latin-ext" rel="stylesheet">
    ...
    <title>Все о космосе. Новости .</title>
    ...
    <div class="container body">
        <header>
            <nav>
                <div class="row">
                    <a>
                        <div class="col-xs-2 col-md-2 col-lg-2 col-md-offset-1 col-lg-offset-1 nav-block-science">
                            <div class="nav-div">
        ...
        <main class="content">
            <div class="row">
                ...
                <div class="col-md-3 col-lg-3">
                    <a href="#">
                        <div class="science-main main-news" style="background: url(img/171ff7bd9d0553f225b83c7229b630a7.jpg) no-repeat;">
                            <div class="newsPadding">
